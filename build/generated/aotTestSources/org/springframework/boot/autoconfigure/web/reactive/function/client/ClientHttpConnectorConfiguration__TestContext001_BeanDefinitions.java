...
public class ClientHttpConnectorConfiguration__TestContext001_BeanDefinitions {
  ...
  public static class ReactorNetty__BeanDefinitions {
    ...
    /**
     * Get the bean instance supplier for 'reactorClientResourceFactory'.
     */
    private static BeanInstanceSupplier<ReactorResourceFactory> getReactorClientResourceFactoryInstanceSupplier(
        ) {
      return BeanInstanceSupplier.<ReactorResourceFactory>forFactoryMethod(ClientHttpConnectorConfiguration.ReactorNetty.class, "reactorClientResourceFactory")
              .withGenerator((registeredBean) -> registeredBean.getBeanFactory().getBean(ClientHttpConnectorConfiguration.ReactorNetty.class).reactorClientResourceFactory());
    }

    /**
     * Get the bean definition for 'reactorClientResourceFactory'
     */
    public static BeanDefinition getReactorClientResourceFactoryBeanDefinition() {
      Class<?> beanType = ReactorResourceFactory.class;
      RootBeanDefinition beanDefinition = new RootBeanDefinition(beanType);
      beanDefinition.setInstanceSupplier(getReactorClientResourceFactoryInstanceSupplier());
      return beanDefinition;
    }
