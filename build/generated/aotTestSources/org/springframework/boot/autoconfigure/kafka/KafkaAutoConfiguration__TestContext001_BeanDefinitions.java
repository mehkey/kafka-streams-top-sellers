 ...
 */
public class KafkaAutoConfiguration__TestContext001_BeanDefinitions {
  /**
  ...
  public static BeanDefinition getKafkaTemplateBeanDefinition() {
    ResolvableType beanType = ResolvableType.forClass(KafkaTemplate.class);
    RootBeanDefinition beanDefinition = new RootBeanDefinition(beanType);
  ...
  public static BeanDefinition getKafkaProducerListenerBeanDefinition() {
    ResolvableType beanType = ResolvableType.forClassWithGenerics(LoggingProducerListener.class, Object.class, Object.class);
    RootBeanDefinition beanDefinition = new RootBeanDefinition(beanType);
  ...
  private static BeanInstanceSupplier<DefaultKafkaConsumerFactory> getKafkaConsumerFactoryInstanceSupplier(
    ...
    return BeanInstanceSupplier.<DefaultKafkaConsumerFactory>forFactoryMethod(KafkaAutoConfiguration.class, "kafkaConsumerFactory", ObjectProvider.class)
  ...
  public static BeanDefinition getKafkaConsumerFactoryBeanDefinition() {
    ResolvableType beanType = ResolvableType.forClass(DefaultKafkaConsumerFactory.class);
    RootBeanDefinition beanDefinition = new RootBeanDefinition(beanType);
  ...
  private static BeanInstanceSupplier<DefaultKafkaProducerFactory> getKafkaProducerFactoryInstanceSupplier(
    ...
    return BeanInstanceSupplier.<DefaultKafkaProducerFactory>forFactoryMethod(KafkaAutoConfiguration.class, "kafkaProducerFactory", ObjectProvider.class)
  ...
  public static BeanDefinition getKafkaProducerFactoryBeanDefinition() {
    ResolvableType beanType = ResolvableType.forClass(DefaultKafkaProducerFactory.class);
    RootBeanDefinition beanDefinition = new RootBeanDefinition(beanType);
