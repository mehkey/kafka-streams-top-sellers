...
import org.springframework.cloud.stream.binding.SubscribableChannelBindingTargetFactory__IntegrationBinderAutowiring;
 ...
 */
public class BinderFactoryAutoConfiguration__IntegrationBinderBeanDefinitions {
  /**
  ...
  public static BeanDefinition getBinderFactoryAutoConfigurationBeanDefinition() {
    ...
    instanceSupplier = instanceSupplier.andThen(BinderFactoryAutoConfiguration__IntegrationBinderAutowiring::apply);
  ...
  public static BeanDefinition getChannelFactoryBeanDefinition() {
    ...
    instanceSupplier = instanceSupplier.andThen(SubscribableChannelBindingTargetFactory__IntegrationBinderAutowiring::apply);
    beanDefinition.setInstanceSupplier(instanceSupplier);
    return beanDefinition;
  }
